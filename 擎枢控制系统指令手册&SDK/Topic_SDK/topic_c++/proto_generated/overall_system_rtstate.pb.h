...
namespace overall_system_rtstate {
class Controller;
...
PROTOBUF_NAMESPACE_OPEN
template<> ::overall_system_rtstate::Controller* Arena::CreateMaybeMessage<::overall_system_rtstate::Controller>(Arena*);
template<> ::overall_system_rtstate::Ftvalue* Arena::CreateMaybeMessage<::overall_system_rtstate::Ftvalue>(Arena*);
template<> ::overall_system_rtstate::Header* Arena::CreateMaybeMessage<::overall_system_rtstate::Header>(Arena*);
template<> ::overall_system_rtstate::Joint* Arena::CreateMaybeMessage<::overall_system_rtstate::Joint>(Arena*);
template<> ::overall_system_rtstate::Load* Arena::CreateMaybeMessage<::overall_system_rtstate::Load>(Arena*);
template<> ::overall_system_rtstate::Model* Arena::CreateMaybeMessage<::overall_system_rtstate::Model>(Arena*);
template<> ::overall_system_rtstate::Point* Arena::CreateMaybeMessage<::overall_system_rtstate::Point>(Arena*);
template<> ::overall_system_rtstate::SystemRtState* Arena::CreateMaybeMessage<::overall_system_rtstate::SystemRtState>(Arena*);
template<> ::overall_system_rtstate::Tool* Arena::CreateMaybeMessage<::overall_system_rtstate::Tool>(Arena*);
template<> ::overall_system_rtstate::Wobj* Arena::CreateMaybeMessage<::overall_system_rtstate::Wobj>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace overall_system_rtstate {
...
class Header final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:overall_system_rtstate.Header) */ {
 public:
  ...
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "overall_system_rtstate.Header";
  }
  protected:
  ...
  // @@protoc_insertion_point(class_scope:overall_system_rtstate.Header)
 private:
  class _Internal;
...
class Ftvalue final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:overall_system_rtstate.Ftvalue) */ {
 public:
  ...
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "overall_system_rtstate.Ftvalue";
  }
  protected:
  ...
  // @@protoc_insertion_point(class_scope:overall_system_rtstate.Ftvalue)
 private:
  class _Internal;
...
class Controller final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:overall_system_rtstate.Controller) */ {
 public:
  ...
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "overall_system_rtstate.Controller";
  }
  protected:
  ...
  // repeated .overall_system_rtstate.Ftvalue ftvalues = 6;
  int ftvalues_size() const;
  private:
  int _internal_ftvalues_size() const;
  public:
  void clear_ftvalues();
  ::overall_system_rtstate::Ftvalue* mutable_ftvalues(int index);
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::overall_system_rtstate::Ftvalue >*
      mutable_ftvalues();
  private:
  const ::overall_system_rtstate::Ftvalue& _internal_ftvalues(int index) const;
  ::overall_system_rtstate::Ftvalue* _internal_add_ftvalues();
  public:
  const ::overall_system_rtstate::Ftvalue& ftvalues(int index) const;
  ::overall_system_rtstate::Ftvalue* add_ftvalues();
  const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::overall_system_rtstate::Ftvalue >&
      ftvalues() const;
  ...
  // @@protoc_insertion_point(class_scope:overall_system_rtstate.Controller)
 private:
  class _Internal;
  ...
  typedef void DestructorSkippable_;
  struct Impl_ {
    ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::overall_system_rtstate::Ftvalue > ftvalues_;
...
class Joint final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:overall_system_rtstate.Joint) */ {
 public:
  ...
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "overall_system_rtstate.Joint";
  }
  protected:
  ...
  // @@protoc_insertion_point(class_scope:overall_system_rtstate.Joint)
 private:
  class _Internal;
...
class Tool final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:overall_system_rtstate.Tool) */ {
 public:
  ...
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "overall_system_rtstate.Tool";
  }
  protected:
  ...
  // @@protoc_insertion_point(class_scope:overall_system_rtstate.Tool)
 private:
  class _Internal;
...
class Wobj final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:overall_system_rtstate.Wobj) */ {
 public:
  ...
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "overall_system_rtstate.Wobj";
  }
  protected:
  ...
  // @@protoc_insertion_point(class_scope:overall_system_rtstate.Wobj)
 private:
  class _Internal;
...
class Load final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:overall_system_rtstate.Load) */ {
 public:
  ...
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "overall_system_rtstate.Load";
  }
  protected:
  ...
  // @@protoc_insertion_point(class_scope:overall_system_rtstate.Load)
 private:
  class _Internal;
...
class Point final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:overall_system_rtstate.Point) */ {
 public:
  ...
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "overall_system_rtstate.Point";
  }
  protected:
  ...
  // .overall_system_rtstate.Tool tool = 2;
  bool has_tool() const;
  private:
  bool _internal_has_tool() const;
  public:
  void clear_tool();
  const ::overall_system_rtstate::Tool& tool() const;
  PROTOBUF_NODISCARD ::overall_system_rtstate::Tool* release_tool();
  ::overall_system_rtstate::Tool* mutable_tool();
  void set_allocated_tool(::overall_system_rtstate::Tool* tool);
  private:
  const ::overall_system_rtstate::Tool& _internal_tool() const;
  ::overall_system_rtstate::Tool* _internal_mutable_tool();
  public:
  void unsafe_arena_set_allocated_tool(
      ::overall_system_rtstate::Tool* tool);
  ::overall_system_rtstate::Tool* unsafe_arena_release_tool();

  // .overall_system_rtstate.Wobj wobj = 3;
  bool has_wobj() const;
  private:
  bool _internal_has_wobj() const;
  public:
  void clear_wobj();
  const ::overall_system_rtstate::Wobj& wobj() const;
  PROTOBUF_NODISCARD ::overall_system_rtstate::Wobj* release_wobj();
  ::overall_system_rtstate::Wobj* mutable_wobj();
  void set_allocated_wobj(::overall_system_rtstate::Wobj* wobj);
  private:
  const ::overall_system_rtstate::Wobj& _internal_wobj() const;
  ::overall_system_rtstate::Wobj* _internal_mutable_wobj();
  public:
  void unsafe_arena_set_allocated_wobj(
      ::overall_system_rtstate::Wobj* wobj);
  ::overall_system_rtstate::Wobj* unsafe_arena_release_wobj();

  // @@protoc_insertion_point(class_scope:overall_system_rtstate.Point)
 private:
  class _Internal;
  ...
  struct Impl_ {
    ...
    ::overall_system_rtstate::Tool* tool_;
    ::overall_system_rtstate::Wobj* wobj_;
    mutable ::PROTOBUF_NAMESPACE_ID::internal::CachedSize _cached_size_;
  };
  union { Impl_ _impl_; };
  friend struct ::TableStruct_overall_5fsystem_5frtstate_2eproto;
...
class Model final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:overall_system_rtstate.Model) */ {
 public:
  ...
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "overall_system_rtstate.Model";
  }
  protected:
  ...
  // repeated .overall_system_rtstate.Joint joint = 3;
  int joint_size() const;
  private:
  int _internal_joint_size() const;
  public:
  void clear_joint();
  ::overall_system_rtstate::Joint* mutable_joint(int index);
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::overall_system_rtstate::Joint >*
      mutable_joint();
  private:
  const ::overall_system_rtstate::Joint& _internal_joint(int index) const;
  ::overall_system_rtstate::Joint* _internal_add_joint();
  public:
  const ::overall_system_rtstate::Joint& joint(int index) const;
  ::overall_system_rtstate::Joint* add_joint();
  const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::overall_system_rtstate::Joint >&
      joint() const;
  ...
  // .overall_system_rtstate.Point current_point = 4;
  bool has_current_point() const;
  private:
  bool _internal_has_current_point() const;
  public:
  void clear_current_point();
  const ::overall_system_rtstate::Point& current_point() const;
  PROTOBUF_NODISCARD ::overall_system_rtstate::Point* release_current_point();
  ::overall_system_rtstate::Point* mutable_current_point();
  void set_allocated_current_point(::overall_system_rtstate::Point* current_point);
  private:
  const ::overall_system_rtstate::Point& _internal_current_point() const;
  ::overall_system_rtstate::Point* _internal_mutable_current_point();
  public:
  void unsafe_arena_set_allocated_current_point(
      ::overall_system_rtstate::Point* current_point);
  ::overall_system_rtstate::Point* unsafe_arena_release_current_point();
  ...
  // @@protoc_insertion_point(class_scope:overall_system_rtstate.Model)
 private:
  class _Internal;
  ...
  typedef void DestructorSkippable_;
  struct Impl_ {
    ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::overall_system_rtstate::Joint > joint_;
    ...
    ::overall_system_rtstate::Point* current_point_;
    int32_t error_code_;
...
class SystemRtState final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:overall_system_rtstate.SystemRtState) */ {
 public:
  ...
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "overall_system_rtstate.SystemRtState";
  }
  protected:
  ...
  // repeated .overall_system_rtstate.Model model = 3;
  int model_size() const;
  private:
  int _internal_model_size() const;
  public:
  void clear_model();
  ::overall_system_rtstate::Model* mutable_model(int index);
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::overall_system_rtstate::Model >*
      mutable_model();
  private:
  const ::overall_system_rtstate::Model& _internal_model(int index) const;
  ::overall_system_rtstate::Model* _internal_add_model();
  public:
  const ::overall_system_rtstate::Model& model(int index) const;
  ::overall_system_rtstate::Model* add_model();
  const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::overall_system_rtstate::Model >&
      model() const;
  ...
  // .overall_system_rtstate.Header head = 1;
  bool has_head() const;
  private:
  bool _internal_has_head() const;
  public:
  void clear_head();
  const ::overall_system_rtstate::Header& head() const;
  PROTOBUF_NODISCARD ::overall_system_rtstate::Header* release_head();
  ::overall_system_rtstate::Header* mutable_head();
  void set_allocated_head(::overall_system_rtstate::Header* head);
  private:
  const ::overall_system_rtstate::Header& _internal_head() const;
  ::overall_system_rtstate::Header* _internal_mutable_head();
  public:
  void unsafe_arena_set_allocated_head(
      ::overall_system_rtstate::Header* head);
  ::overall_system_rtstate::Header* unsafe_arena_release_head();

  // .overall_system_rtstate.Controller controller = 4;
  bool has_controller() const;
  private:
  bool _internal_has_controller() const;
  public:
  void clear_controller();
  const ::overall_system_rtstate::Controller& controller() const;
  PROTOBUF_NODISCARD ::overall_system_rtstate::Controller* release_controller();
  ::overall_system_rtstate::Controller* mutable_controller();
  void set_allocated_controller(::overall_system_rtstate::Controller* controller);
  private:
  const ::overall_system_rtstate::Controller& _internal_controller() const;
  ::overall_system_rtstate::Controller* _internal_mutable_controller();
  public:
  void unsafe_arena_set_allocated_controller(
      ::overall_system_rtstate::Controller* controller);
  ::overall_system_rtstate::Controller* unsafe_arena_release_controller();
  ...
  // @@protoc_insertion_point(class_scope:overall_system_rtstate.SystemRtState)
 private:
  class _Internal;
  ...
  typedef void DestructorSkippable_;
  struct Impl_ {
    ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::overall_system_rtstate::Model > model_;
    ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr system_info_;
    ::overall_system_rtstate::Header* head_;
    ::overall_system_rtstate::Controller* controller_;
...
inline int64_t Header::timestamp() const {
  // @@protoc_insertion_point(field_get:overall_system_rtstate.Header.timestamp)
...
inline void Header::set_timestamp(int64_t value) {
  ...
  // @@protoc_insertion_point(field_set:overall_system_rtstate.Header.timestamp)
}
...
inline int64_t Header::frame_id() const {
  // @@protoc_insertion_point(field_get:overall_system_rtstate.Header.frame_id)
...
inline void Header::set_frame_id(int64_t value) {
  ...
  // @@protoc_insertion_point(field_set:overall_system_rtstate.Header.frame_id)
}
...
inline double Ftvalue::fx() const {
  // @@protoc_insertion_point(field_get:overall_system_rtstate.Ftvalue.fx)
  return _internal_fx();
}
...
inline void Ftvalue::set_fx(double value) {
  ...
  // @@protoc_insertion_point(field_set:overall_system_rtstate.Ftvalue.fx)
}
...
inline double Ftvalue::fy() const {
  // @@protoc_insertion_point(field_get:overall_system_rtstate.Ftvalue.fy)
  return _internal_fy();
}
...
inline void Ftvalue::set_fy(double value) {
  ...
  // @@protoc_insertion_point(field_set:overall_system_rtstate.Ftvalue.fy)
}
...
inline double Ftvalue::fz() const {
  // @@protoc_insertion_point(field_get:overall_system_rtstate.Ftvalue.fz)
  return _internal_fz();
}
...
inline void Ftvalue::set_fz(double value) {
  ...
  // @@protoc_insertion_point(field_set:overall_system_rtstate.Ftvalue.fz)
}
...
inline double Ftvalue::mx() const {
  // @@protoc_insertion_point(field_get:overall_system_rtstate.Ftvalue.mx)
  return _internal_mx();
}
...
inline void Ftvalue::set_mx(double value) {
  ...
  // @@protoc_insertion_point(field_set:overall_system_rtstate.Ftvalue.mx)
}
...
inline double Ftvalue::my() const {
  // @@protoc_insertion_point(field_get:overall_system_rtstate.Ftvalue.my)
  return _internal_my();
}
...
inline void Ftvalue::set_my(double value) {
  ...
  // @@protoc_insertion_point(field_set:overall_system_rtstate.Ftvalue.my)
}
...
inline double Ftvalue::mz() const {
  // @@protoc_insertion_point(field_get:overall_system_rtstate.Ftvalue.mz)
  return _internal_mz();
}
...
inline void Ftvalue::set_mz(double value) {
  ...
  // @@protoc_insertion_point(field_set:overall_system_rtstate.Ftvalue.mz)
}
...
inline const std::string& Controller::controller_name() const {
  // @@protoc_insertion_point(field_get:overall_system_rtstate.Controller.controller_name)
...
void Controller::set_controller_name(ArgT0&& arg0, ArgT... args) {
 ...
 _impl_.controller_name_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:overall_system_rtstate.Controller.controller_name)
}
inline std::string* Controller::mutable_controller_name() {
  std::string* _s = _internal_mutable_controller_name();
  // @@protoc_insertion_point(field_mutable:overall_system_rtstate.Controller.controller_name)
  return _s;
}
...
inline std::string* Controller::release_controller_name() {
  // @@protoc_insertion_point(field_release:overall_system_rtstate.Controller.controller_name)
...
inline void Controller::set_allocated_controller_name(std::string* controller_name) {
  ...
  // @@protoc_insertion_point(field_set_allocated:overall_system_rtstate.Controller.controller_name)
}
...
inline double Controller::control_cycle() const {
  // @@protoc_insertion_point(field_get:overall_system_rtstate.Controller.control_cycle)
...
inline void Controller::set_control_cycle(double value) {
  ...
  // @@protoc_insertion_point(field_set:overall_system_rtstate.Controller.control_cycle)
}
...
inline int64_t Controller::global_count() const {
  // @@protoc_insertion_point(field_get:overall_system_rtstate.Controller.global_count)
...
inline void Controller::set_global_count(int64_t value) {
  ...
  // @@protoc_insertion_point(field_set:overall_system_rtstate.Controller.global_count)
}
...
inline const std::string& Controller::master_info() const {
  // @@protoc_insertion_point(field_get:overall_system_rtstate.Controller.master_info)
...
void Controller::set_master_info(ArgT0&& arg0, ArgT... args) {
 ...
 _impl_.master_info_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:overall_system_rtstate.Controller.master_info)
}
inline std::string* Controller::mutable_master_info() {
  std::string* _s = _internal_mutable_master_info();
  // @@protoc_insertion_point(field_mutable:overall_system_rtstate.Controller.master_info)
  return _s;
}
...
inline std::string* Controller::release_master_info() {
  // @@protoc_insertion_point(field_release:overall_system_rtstate.Controller.master_info)
...
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:overall_system_rtstate.Controller.master_info)
}
...
inline bool Controller::is_link_up() const {
  // @@protoc_insertion_point(field_get:overall_system_rtstate.Controller.is_link_up)
...
inline void Controller::set_is_link_up(bool value) {
  ...
  // @@protoc_insertion_point(field_set:overall_system_rtstate.Controller.is_link_up)
}
...
inline ::overall_system_rtstate::Ftvalue* Controller::mutable_ftvalues(int index) {
  // @@protoc_insertion_point(field_mutable:overall_system_rtstate.Controller.ftvalues)
  return _impl_.ftvalues_.Mutable(index);
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::overall_system_rtstate::Ftvalue >*
Controller::mutable_ftvalues() {
  // @@protoc_insertion_point(field_mutable_list:overall_system_rtstate.Controller.ftvalues)
  return &_impl_.ftvalues_;
}
inline const ::overall_system_rtstate::Ftvalue& Controller::_internal_ftvalues(int index) const {
  return _impl_.ftvalues_.Get(index);
}
inline const ::overall_system_rtstate::Ftvalue& Controller::ftvalues(int index) const {
  // @@protoc_insertion_point(field_get:overall_system_rtstate.Controller.ftvalues)
  return _internal_ftvalues(index);
}
inline ::overall_system_rtstate::Ftvalue* Controller::_internal_add_ftvalues() {
  return _impl_.ftvalues_.Add();
}
inline ::overall_system_rtstate::Ftvalue* Controller::add_ftvalues() {
  ::overall_system_rtstate::Ftvalue* _add = _internal_add_ftvalues();
  // @@protoc_insertion_point(field_add:overall_system_rtstate.Controller.ftvalues)
  return _add;
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::overall_system_rtstate::Ftvalue >&
Controller::ftvalues() const {
  // @@protoc_insertion_point(field_list:overall_system_rtstate.Controller.ftvalues)
  return _impl_.ftvalues_;
}
...
inline const std::string& Joint::joint_type() const {
  // @@protoc_insertion_point(field_get:overall_system_rtstate.Joint.joint_type)
...
void Joint::set_joint_type(ArgT0&& arg0, ArgT... args) {
 ...
 _impl_.joint_type_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:overall_system_rtstate.Joint.joint_type)
}
inline std::string* Joint::mutable_joint_type() {
  std::string* _s = _internal_mutable_joint_type();
  // @@protoc_insertion_point(field_mutable:overall_system_rtstate.Joint.joint_type)
  return _s;
}
...
inline std::string* Joint::release_joint_type() {
  // @@protoc_insertion_point(field_release:overall_system_rtstate.Joint.joint_type)
...
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:overall_system_rtstate.Joint.joint_type)
}
...
inline double Joint::position() const {
  // @@protoc_insertion_point(field_get:overall_system_rtstate.Joint.position)
...
inline void Joint::set_position(double value) {
  ...
  // @@protoc_insertion_point(field_set:overall_system_rtstate.Joint.position)
}
...
inline double Joint::torque() const {
  // @@protoc_insertion_point(field_get:overall_system_rtstate.Joint.torque)
...
inline void Joint::set_torque(double value) {
  ...
  // @@protoc_insertion_point(field_set:overall_system_rtstate.Joint.torque)
}
...
inline bool Joint::is_enabled() const {
  // @@protoc_insertion_point(field_get:overall_system_rtstate.Joint.is_enabled)
...
inline void Joint::set_is_enabled(bool value) {
  ...
  // @@protoc_insertion_point(field_set:overall_system_rtstate.Joint.is_enabled)
}
...
inline int32_t Joint::mode() const {
  // @@protoc_insertion_point(field_get:overall_system_rtstate.Joint.mode)
...
inline void Joint::set_mode(int32_t value) {
  ...
  // @@protoc_insertion_point(field_set:overall_system_rtstate.Joint.mode)
}
...
inline int32_t Joint::error_code() const {
  // @@protoc_insertion_point(field_get:overall_system_rtstate.Joint.error_code)
...
inline void Joint::set_error_code(int32_t value) {
  ...
  // @@protoc_insertion_point(field_set:overall_system_rtstate.Joint.error_code)
}
...
inline int32_t Joint::digit_output() const {
  // @@protoc_insertion_point(field_get:overall_system_rtstate.Joint.digit_output)
...
inline void Joint::set_digit_output(int32_t value) {
  ...
  // @@protoc_insertion_point(field_set:overall_system_rtstate.Joint.digit_output)
}
...
inline int32_t Joint::digit_input() const {
  // @@protoc_insertion_point(field_get:overall_system_rtstate.Joint.digit_input)
...
inline void Joint::set_digit_input(int32_t value) {
  ...
  // @@protoc_insertion_point(field_set:overall_system_rtstate.Joint.digit_input)
}
...
inline double Joint::sensor_torque() const {
  // @@protoc_insertion_point(field_get:overall_system_rtstate.Joint.sensor_torque)
...
inline void Joint::set_sensor_torque(double value) {
  ...
  // @@protoc_insertion_point(field_set:overall_system_rtstate.Joint.sensor_torque)
}
...
inline double Joint::velocity() const {
  // @@protoc_insertion_point(field_get:overall_system_rtstate.Joint.velocity)
...
inline void Joint::set_velocity(double value) {
  ...
  // @@protoc_insertion_point(field_set:overall_system_rtstate.Joint.velocity)
}

// double target_position = 11;
inline void Joint::clear_target_position() {
  _impl_.target_position_ = 0;
}
inline double Joint::_internal_target_position() const {
  return _impl_.target_position_;
}
inline double Joint::target_position() const {
  // @@protoc_insertion_point(field_get:overall_system_rtstate.Joint.target_position)
  return _internal_target_position();
}
inline void Joint::_internal_set_target_position(double value) {
  
  _impl_.target_position_ = value;
}
inline void Joint::set_target_position(double value) {
  _internal_set_target_position(value);
  // @@protoc_insertion_point(field_set:overall_system_rtstate.Joint.target_position)
}
...
inline const std::string& Tool::tool_name() const {
  // @@protoc_insertion_point(field_get:overall_system_rtstate.Tool.tool_name)
...
void Tool::set_tool_name(ArgT0&& arg0, ArgT... args) {
 ...
 _impl_.tool_name_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:overall_system_rtstate.Tool.tool_name)
}
inline std::string* Tool::mutable_tool_name() {
  std::string* _s = _internal_mutable_tool_name();
  // @@protoc_insertion_point(field_mutable:overall_system_rtstate.Tool.tool_name)
  return _s;
}
...
inline std::string* Tool::release_tool_name() {
  // @@protoc_insertion_point(field_release:overall_system_rtstate.Tool.tool_name)
...
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:overall_system_rtstate.Tool.tool_name)
}
...
inline double Tool::data(int index) const {
  // @@protoc_insertion_point(field_get:overall_system_rtstate.Tool.data)
  return _internal_data(index);
}
inline void Tool::set_data(int index, double value) {
  _impl_.data_.Set(index, value);
  // @@protoc_insertion_point(field_set:overall_system_rtstate.Tool.data)
}
...
inline void Tool::add_data(double value) {
  ...
  // @@protoc_insertion_point(field_add:overall_system_rtstate.Tool.data)
}
...
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedField< double >&
Tool::data() const {
  // @@protoc_insertion_point(field_list:overall_system_rtstate.Tool.data)
...
inline ::PROTOBUF_NAMESPACE_ID::RepeatedField< double >*
Tool::mutable_data() {
  // @@protoc_insertion_point(field_mutable_list:overall_system_rtstate.Tool.data)
...
inline const std::string& Wobj::wobj_name() const {
  // @@protoc_insertion_point(field_get:overall_system_rtstate.Wobj.wobj_name)
...
void Wobj::set_wobj_name(ArgT0&& arg0, ArgT... args) {
 ...
 _impl_.wobj_name_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:overall_system_rtstate.Wobj.wobj_name)
}
inline std::string* Wobj::mutable_wobj_name() {
  std::string* _s = _internal_mutable_wobj_name();
  // @@protoc_insertion_point(field_mutable:overall_system_rtstate.Wobj.wobj_name)
  return _s;
}
...
inline std::string* Wobj::release_wobj_name() {
  // @@protoc_insertion_point(field_release:overall_system_rtstate.Wobj.wobj_name)
...
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:overall_system_rtstate.Wobj.wobj_name)
}
...
inline double Wobj::data(int index) const {
  // @@protoc_insertion_point(field_get:overall_system_rtstate.Wobj.data)
  return _internal_data(index);
}
inline void Wobj::set_data(int index, double value) {
  _impl_.data_.Set(index, value);
  // @@protoc_insertion_point(field_set:overall_system_rtstate.Wobj.data)
}
...
inline void Wobj::add_data(double value) {
  _internal_add_data(value);
  // @@protoc_insertion_point(field_add:overall_system_rtstate.Wobj.data)
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedField< double >&
...
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedField< double >&
Wobj::data() const {
  // @@protoc_insertion_point(field_list:overall_system_rtstate.Wobj.data)
  return _internal_data();
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedField< double >*
...
inline ::PROTOBUF_NAMESPACE_ID::RepeatedField< double >*
Wobj::mutable_data() {
  // @@protoc_insertion_point(field_mutable_list:overall_system_rtstate.Wobj.data)
  return _internal_mutable_data();
}
...
inline const std::string& Load::load_name() const {
  // @@protoc_insertion_point(field_get:overall_system_rtstate.Load.load_name)
...
void Load::set_load_name(ArgT0&& arg0, ArgT... args) {
 ...
 _impl_.load_name_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:overall_system_rtstate.Load.load_name)
}
inline std::string* Load::mutable_load_name() {
  std::string* _s = _internal_mutable_load_name();
  // @@protoc_insertion_point(field_mutable:overall_system_rtstate.Load.load_name)
  return _s;
}
...
inline std::string* Load::release_load_name() {
  // @@protoc_insertion_point(field_release:overall_system_rtstate.Load.load_name)
...
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:overall_system_rtstate.Load.load_name)
}
...
inline double Load::data(int index) const {
  // @@protoc_insertion_point(field_get:overall_system_rtstate.Load.data)
  return _internal_data(index);
}
inline void Load::set_data(int index, double value) {
  _impl_.data_.Set(index, value);
  // @@protoc_insertion_point(field_set:overall_system_rtstate.Load.data)
}
...
inline void Load::add_data(double value) {
  _internal_add_data(value);
  // @@protoc_insertion_point(field_add:overall_system_rtstate.Load.data)
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedField< double >&
...
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedField< double >&
Load::data() const {
  // @@protoc_insertion_point(field_list:overall_system_rtstate.Load.data)
  return _internal_data();
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedField< double >*
...
inline ::PROTOBUF_NAMESPACE_ID::RepeatedField< double >*
Load::mutable_data() {
  // @@protoc_insertion_point(field_mutable_list:overall_system_rtstate.Load.data)
  return _internal_mutable_data();
}
...
inline const std::string& Point::point_name() const {
  // @@protoc_insertion_point(field_get:overall_system_rtstate.Point.point_name)
...
void Point::set_point_name(ArgT0&& arg0, ArgT... args) {
 ...
 _impl_.point_name_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:overall_system_rtstate.Point.point_name)
}
inline std::string* Point::mutable_point_name() {
  std::string* _s = _internal_mutable_point_name();
  // @@protoc_insertion_point(field_mutable:overall_system_rtstate.Point.point_name)
  return _s;
}
...
inline std::string* Point::release_point_name() {
  // @@protoc_insertion_point(field_release:overall_system_rtstate.Point.point_name)
...
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:overall_system_rtstate.Point.point_name)
}
...
inline const ::overall_system_rtstate::Tool& Point::_internal_tool() const {
  const ::overall_system_rtstate::Tool* p = _impl_.tool_;
  return p != nullptr ? *p : reinterpret_cast<const ::overall_system_rtstate::Tool&>(
      ::overall_system_rtstate::_Tool_default_instance_);
}
inline const ::overall_system_rtstate::Tool& Point::tool() const {
  // @@protoc_insertion_point(field_get:overall_system_rtstate.Point.tool)
...
inline void Point::unsafe_arena_set_allocated_tool(
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:overall_system_rtstate.Point.tool)
}
inline ::overall_system_rtstate::Tool* Point::release_tool() {
  
  ::overall_system_rtstate::Tool* temp = _impl_.tool_;
  _impl_.tool_ = nullptr;
...
inline ::overall_system_rtstate::Tool* Point::unsafe_arena_release_tool() {
  // @@protoc_insertion_point(field_release:overall_system_rtstate.Point.tool)
  
  ::overall_system_rtstate::Tool* temp = _impl_.tool_;
  _impl_.tool_ = nullptr;
  return temp;
}
inline ::overall_system_rtstate::Tool* Point::_internal_mutable_tool() {
  
  if (_impl_.tool_ == nullptr) {
    auto* p = CreateMaybeMessage<::overall_system_rtstate::Tool>(GetArenaForAllocation());
    _impl_.tool_ = p;
  }
  return _impl_.tool_;
}
inline ::overall_system_rtstate::Tool* Point::mutable_tool() {
  ::overall_system_rtstate::Tool* _msg = _internal_mutable_tool();
  // @@protoc_insertion_point(field_mutable:overall_system_rtstate.Point.tool)
  return _msg;
}
inline void Point::set_allocated_tool(::overall_system_rtstate::Tool* tool) {
  ...
  _impl_.tool_ = tool;
  // @@protoc_insertion_point(field_set_allocated:overall_system_rtstate.Point.tool)
}
...
inline const ::overall_system_rtstate::Wobj& Point::_internal_wobj() const {
  const ::overall_system_rtstate::Wobj* p = _impl_.wobj_;
  return p != nullptr ? *p : reinterpret_cast<const ::overall_system_rtstate::Wobj&>(
      ::overall_system_rtstate::_Wobj_default_instance_);
}
inline const ::overall_system_rtstate::Wobj& Point::wobj() const {
  // @@protoc_insertion_point(field_get:overall_system_rtstate.Point.wobj)
...
inline void Point::unsafe_arena_set_allocated_wobj(
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:overall_system_rtstate.Point.wobj)
}
inline ::overall_system_rtstate::Wobj* Point::release_wobj() {
  
  ::overall_system_rtstate::Wobj* temp = _impl_.wobj_;
  _impl_.wobj_ = nullptr;
#ifdef PROTOBUF_FORCE_COPY_IN_RELEASE
  auto* old =  reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(temp);
  temp = ::PROTOBUF_NAMESPACE_ID::internal::DuplicateIfNonNull(temp);
...
inline ::overall_system_rtstate::Wobj* Point::unsafe_arena_release_wobj() {
  // @@protoc_insertion_point(field_release:overall_system_rtstate.Point.wobj)
  
  ::overall_system_rtstate::Wobj* temp = _impl_.wobj_;
  _impl_.wobj_ = nullptr;
  return temp;
}
inline ::overall_system_rtstate::Wobj* Point::_internal_mutable_wobj() {
  
  if (_impl_.wobj_ == nullptr) {
    auto* p = CreateMaybeMessage<::overall_system_rtstate::Wobj>(GetArenaForAllocation());
    _impl_.wobj_ = p;
  }
  return _impl_.wobj_;
}
inline ::overall_system_rtstate::Wobj* Point::mutable_wobj() {
  ::overall_system_rtstate::Wobj* _msg = _internal_mutable_wobj();
  // @@protoc_insertion_point(field_mutable:overall_system_rtstate.Point.wobj)
  return _msg;
}
inline void Point::set_allocated_wobj(::overall_system_rtstate::Wobj* wobj) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArenaForAllocation();
  if (message_arena == nullptr) {
    delete _impl_.wobj_;
  }
  ...
  _impl_.wobj_ = wobj;
  // @@protoc_insertion_point(field_set_allocated:overall_system_rtstate.Point.wobj)
}
...
inline double Point::robottarget(int index) const {
  // @@protoc_insertion_point(field_get:overall_system_rtstate.Point.robottarget)
...
inline void Point::set_robottarget(int index, double value) {
  ...
  // @@protoc_insertion_point(field_set:overall_system_rtstate.Point.robottarget)
}
...
inline void Point::add_robottarget(double value) {
  ...
  // @@protoc_insertion_point(field_add:overall_system_rtstate.Point.robottarget)
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedField< double >&
...
Point::robottarget() const {
  // @@protoc_insertion_point(field_list:overall_system_rtstate.Point.robottarget)
...
Point::mutable_robottarget() {
  // @@protoc_insertion_point(field_mutable_list:overall_system_rtstate.Point.robottarget)
...
inline double Point::jointtarget(int index) const {
  // @@protoc_insertion_point(field_get:overall_system_rtstate.Point.jointtarget)
...
inline void Point::set_jointtarget(int index, double value) {
  ...
  // @@protoc_insertion_point(field_set:overall_system_rtstate.Point.jointtarget)
}
...
inline void Point::add_jointtarget(double value) {
  ...
  // @@protoc_insertion_point(field_add:overall_system_rtstate.Point.jointtarget)
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedField< double >&
...
Point::jointtarget() const {
  // @@protoc_insertion_point(field_list:overall_system_rtstate.Point.jointtarget)
...
Point::mutable_jointtarget() {
  // @@protoc_insertion_point(field_mutable_list:overall_system_rtstate.Point.jointtarget)
...
inline const std::string& Model::model_name() const {
  // @@protoc_insertion_point(field_get:overall_system_rtstate.Model.model_name)
...
void Model::set_model_name(ArgT0&& arg0, ArgT... args) {
 ...
 _impl_.model_name_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:overall_system_rtstate.Model.model_name)
}
inline std::string* Model::mutable_model_name() {
  std::string* _s = _internal_mutable_model_name();
  // @@protoc_insertion_point(field_mutable:overall_system_rtstate.Model.model_name)
  return _s;
}
...
inline std::string* Model::release_model_name() {
  // @@protoc_insertion_point(field_release:overall_system_rtstate.Model.model_name)
...
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:overall_system_rtstate.Model.model_name)
}
...
inline const std::string& Model::model_type() const {
  // @@protoc_insertion_point(field_get:overall_system_rtstate.Model.model_type)
...
void Model::set_model_type(ArgT0&& arg0, ArgT... args) {
 ...
 _impl_.model_type_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:overall_system_rtstate.Model.model_type)
}
inline std::string* Model::mutable_model_type() {
  std::string* _s = _internal_mutable_model_type();
  // @@protoc_insertion_point(field_mutable:overall_system_rtstate.Model.model_type)
  return _s;
}
...
inline std::string* Model::release_model_type() {
  // @@protoc_insertion_point(field_release:overall_system_rtstate.Model.model_type)
...
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:overall_system_rtstate.Model.model_type)
}
...
inline ::overall_system_rtstate::Joint* Model::mutable_joint(int index) {
  // @@protoc_insertion_point(field_mutable:overall_system_rtstate.Model.joint)
  return _impl_.joint_.Mutable(index);
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::overall_system_rtstate::Joint >*
Model::mutable_joint() {
  // @@protoc_insertion_point(field_mutable_list:overall_system_rtstate.Model.joint)
  return &_impl_.joint_;
}
inline const ::overall_system_rtstate::Joint& Model::_internal_joint(int index) const {
  return _impl_.joint_.Get(index);
}
inline const ::overall_system_rtstate::Joint& Model::joint(int index) const {
  // @@protoc_insertion_point(field_get:overall_system_rtstate.Model.joint)
  return _internal_joint(index);
}
inline ::overall_system_rtstate::Joint* Model::_internal_add_joint() {
  return _impl_.joint_.Add();
}
inline ::overall_system_rtstate::Joint* Model::add_joint() {
  ::overall_system_rtstate::Joint* _add = _internal_add_joint();
  // @@protoc_insertion_point(field_add:overall_system_rtstate.Model.joint)
  return _add;
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::overall_system_rtstate::Joint >&
Model::joint() const {
  // @@protoc_insertion_point(field_list:overall_system_rtstate.Model.joint)
  return _impl_.joint_;
}
...
inline const ::overall_system_rtstate::Point& Model::_internal_current_point() const {
  const ::overall_system_rtstate::Point* p = _impl_.current_point_;
  return p != nullptr ? *p : reinterpret_cast<const ::overall_system_rtstate::Point&>(
      ::overall_system_rtstate::_Point_default_instance_);
}
inline const ::overall_system_rtstate::Point& Model::current_point() const {
  // @@protoc_insertion_point(field_get:overall_system_rtstate.Model.current_point)
...
inline void Model::unsafe_arena_set_allocated_current_point(
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:overall_system_rtstate.Model.current_point)
}
inline ::overall_system_rtstate::Point* Model::release_current_point() {
  
  ::overall_system_rtstate::Point* temp = _impl_.current_point_;
  _impl_.current_point_ = nullptr;
#ifdef PROTOBUF_FORCE_COPY_IN_RELEASE
  auto* old =  reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(temp);
  temp = ::PROTOBUF_NAMESPACE_ID::internal::DuplicateIfNonNull(temp);
...
inline ::overall_system_rtstate::Point* Model::unsafe_arena_release_current_point() {
  // @@protoc_insertion_point(field_release:overall_system_rtstate.Model.current_point)
  
  ::overall_system_rtstate::Point* temp = _impl_.current_point_;
  _impl_.current_point_ = nullptr;
  return temp;
}
inline ::overall_system_rtstate::Point* Model::_internal_mutable_current_point() {
  
  if (_impl_.current_point_ == nullptr) {
    auto* p = CreateMaybeMessage<::overall_system_rtstate::Point>(GetArenaForAllocation());
    _impl_.current_point_ = p;
  }
  return _impl_.current_point_;
}
inline ::overall_system_rtstate::Point* Model::mutable_current_point() {
  ::overall_system_rtstate::Point* _msg = _internal_mutable_current_point();
  // @@protoc_insertion_point(field_mutable:overall_system_rtstate.Model.current_point)
  return _msg;
}
inline void Model::set_allocated_current_point(::overall_system_rtstate::Point* current_point) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArenaForAllocation();
  if (message_arena == nullptr) {
    delete _impl_.current_point_;
  }
  ...
  _impl_.current_point_ = current_point;
  // @@protoc_insertion_point(field_set_allocated:overall_system_rtstate.Model.current_point)
}
...
inline int32_t Model::error_code() const {
  // @@protoc_insertion_point(field_get:overall_system_rtstate.Model.error_code)
  return _internal_error_code();
}
...
inline void Model::set_error_code(int32_t value) {
  _internal_set_error_code(value);
  // @@protoc_insertion_point(field_set:overall_system_rtstate.Model.error_code)
}
...
inline const std::string& Model::error_msg() const {
  // @@protoc_insertion_point(field_get:overall_system_rtstate.Model.error_msg)
...
void Model::set_error_msg(ArgT0&& arg0, ArgT... args) {
 ...
 _impl_.error_msg_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:overall_system_rtstate.Model.error_msg)
}
inline std::string* Model::mutable_error_msg() {
  std::string* _s = _internal_mutable_error_msg();
  // @@protoc_insertion_point(field_mutable:overall_system_rtstate.Model.error_msg)
  return _s;
}
...
inline std::string* Model::release_error_msg() {
  // @@protoc_insertion_point(field_release:overall_system_rtstate.Model.error_msg)
...
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:overall_system_rtstate.Model.error_msg)
}
...
inline int32_t Model::model_state() const {
  // @@protoc_insertion_point(field_get:overall_system_rtstate.Model.model_state)
...
inline void Model::set_model_state(int32_t value) {
  ...
  // @@protoc_insertion_point(field_set:overall_system_rtstate.Model.model_state)
}
...
inline double Model::model_time_rate() const {
  // @@protoc_insertion_point(field_get:overall_system_rtstate.Model.model_time_rate)
...
inline void Model::set_model_time_rate(double value) {
  ...
  // @@protoc_insertion_point(field_set:overall_system_rtstate.Model.model_time_rate)
}
...
inline const std::string& Model::current_func_name() const {
  // @@protoc_insertion_point(field_get:overall_system_rtstate.Model.current_func_name)
...
void Model::set_current_func_name(ArgT0&& arg0, ArgT... args) {
 ...
 _impl_.current_func_name_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:overall_system_rtstate.Model.current_func_name)
}
inline std::string* Model::mutable_current_func_name() {
  std::string* _s = _internal_mutable_current_func_name();
  // @@protoc_insertion_point(field_mutable:overall_system_rtstate.Model.current_func_name)
  return _s;
}
...
inline std::string* Model::release_current_func_name() {
  // @@protoc_insertion_point(field_release:overall_system_rtstate.Model.current_func_name)
...
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:overall_system_rtstate.Model.current_func_name)
}
...
inline const std::string& Model::current_func_info() const {
  // @@protoc_insertion_point(field_get:overall_system_rtstate.Model.current_func_info)
...
void Model::set_current_func_info(ArgT0&& arg0, ArgT... args) {
 ...
 _impl_.current_func_info_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:overall_system_rtstate.Model.current_func_info)
}
inline std::string* Model::mutable_current_func_info() {
  std::string* _s = _internal_mutable_current_func_info();
  // @@protoc_insertion_point(field_mutable:overall_system_rtstate.Model.current_func_info)
  return _s;
}
...
inline std::string* Model::release_current_func_info() {
  // @@protoc_insertion_point(field_release:overall_system_rtstate.Model.current_func_info)
...
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:overall_system_rtstate.Model.current_func_info)
}
...
inline int32_t Model::func_count() const {
  // @@protoc_insertion_point(field_get:overall_system_rtstate.Model.func_count)
...
inline void Model::set_func_count(int32_t value) {
  ...
  // @@protoc_insertion_point(field_set:overall_system_rtstate.Model.func_count)
}
...
inline const std::string& Model::info_msg() const {
  // @@protoc_insertion_point(field_get:overall_system_rtstate.Model.info_msg)
...
void Model::set_info_msg(ArgT0&& arg0, ArgT... args) {
 ...
 _impl_.info_msg_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:overall_system_rtstate.Model.info_msg)
}
inline std::string* Model::mutable_info_msg() {
  std::string* _s = _internal_mutable_info_msg();
  // @@protoc_insertion_point(field_mutable:overall_system_rtstate.Model.info_msg)
  return _s;
}
...
inline std::string* Model::release_info_msg() {
  // @@protoc_insertion_point(field_release:overall_system_rtstate.Model.info_msg)
...
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:overall_system_rtstate.Model.info_msg)
}
...
inline double Model::ee_pe321(int index) const {
  // @@protoc_insertion_point(field_get:overall_system_rtstate.Model.ee_pe321)
  return _internal_ee_pe321(index);
}
inline void Model::set_ee_pe321(int index, double value) {
  _impl_.ee_pe321_.Set(index, value);
  // @@protoc_insertion_point(field_set:overall_system_rtstate.Model.ee_pe321)
}
...
inline void Model::add_ee_pe321(double value) {
  ...
  // @@protoc_insertion_point(field_add:overall_system_rtstate.Model.ee_pe321)
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedField< double >&
...
Model::ee_pe321() const {
  // @@protoc_insertion_point(field_list:overall_system_rtstate.Model.ee_pe321)
...
Model::mutable_ee_pe321() {
  // @@protoc_insertion_point(field_mutable_list:overall_system_rtstate.Model.ee_pe321)
...
inline const ::overall_system_rtstate::Header& SystemRtState::_internal_head() const {
  const ::overall_system_rtstate::Header* p = _impl_.head_;
  return p != nullptr ? *p : reinterpret_cast<const ::overall_system_rtstate::Header&>(
      ::overall_system_rtstate::_Header_default_instance_);
}
inline const ::overall_system_rtstate::Header& SystemRtState::head() const {
  // @@protoc_insertion_point(field_get:overall_system_rtstate.SystemRtState.head)
...
inline void SystemRtState::unsafe_arena_set_allocated_head(
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:overall_system_rtstate.SystemRtState.head)
}
inline ::overall_system_rtstate::Header* SystemRtState::release_head() {
  
  ::overall_system_rtstate::Header* temp = _impl_.head_;
  _impl_.head_ = nullptr;
#ifdef PROTOBUF_FORCE_COPY_IN_RELEASE
  auto* old =  reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(temp);
  temp = ::PROTOBUF_NAMESPACE_ID::internal::DuplicateIfNonNull(temp);
...
inline ::overall_system_rtstate::Header* SystemRtState::unsafe_arena_release_head() {
  // @@protoc_insertion_point(field_release:overall_system_rtstate.SystemRtState.head)
  
  ::overall_system_rtstate::Header* temp = _impl_.head_;
  _impl_.head_ = nullptr;
  return temp;
}
inline ::overall_system_rtstate::Header* SystemRtState::_internal_mutable_head() {
  
  if (_impl_.head_ == nullptr) {
    auto* p = CreateMaybeMessage<::overall_system_rtstate::Header>(GetArenaForAllocation());
    _impl_.head_ = p;
  }
  return _impl_.head_;
}
inline ::overall_system_rtstate::Header* SystemRtState::mutable_head() {
  ::overall_system_rtstate::Header* _msg = _internal_mutable_head();
  // @@protoc_insertion_point(field_mutable:overall_system_rtstate.SystemRtState.head)
  return _msg;
}
inline void SystemRtState::set_allocated_head(::overall_system_rtstate::Header* head) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArenaForAllocation();
  if (message_arena == nullptr) {
    delete _impl_.head_;
  }
  ...
  _impl_.head_ = head;
  // @@protoc_insertion_point(field_set_allocated:overall_system_rtstate.SystemRtState.head)
}
...
inline bool SystemRtState::system_running_state() const {
  // @@protoc_insertion_point(field_get:overall_system_rtstate.SystemRtState.system_running_state)
...
inline void SystemRtState::set_system_running_state(bool value) {
  ...
  // @@protoc_insertion_point(field_set:overall_system_rtstate.SystemRtState.system_running_state)
}
...
inline ::overall_system_rtstate::Model* SystemRtState::mutable_model(int index) {
  // @@protoc_insertion_point(field_mutable:overall_system_rtstate.SystemRtState.model)
  return _impl_.model_.Mutable(index);
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::overall_system_rtstate::Model >*
SystemRtState::mutable_model() {
  // @@protoc_insertion_point(field_mutable_list:overall_system_rtstate.SystemRtState.model)
  return &_impl_.model_;
}
inline const ::overall_system_rtstate::Model& SystemRtState::_internal_model(int index) const {
  return _impl_.model_.Get(index);
}
inline const ::overall_system_rtstate::Model& SystemRtState::model(int index) const {
  // @@protoc_insertion_point(field_get:overall_system_rtstate.SystemRtState.model)
  return _internal_model(index);
}
inline ::overall_system_rtstate::Model* SystemRtState::_internal_add_model() {
  return _impl_.model_.Add();
}
inline ::overall_system_rtstate::Model* SystemRtState::add_model() {
  ::overall_system_rtstate::Model* _add = _internal_add_model();
  // @@protoc_insertion_point(field_add:overall_system_rtstate.SystemRtState.model)
  return _add;
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::overall_system_rtstate::Model >&
SystemRtState::model() const {
  // @@protoc_insertion_point(field_list:overall_system_rtstate.SystemRtState.model)
  return _impl_.model_;
}
...
inline const ::overall_system_rtstate::Controller& SystemRtState::_internal_controller() const {
  const ::overall_system_rtstate::Controller* p = _impl_.controller_;
  return p != nullptr ? *p : reinterpret_cast<const ::overall_system_rtstate::Controller&>(
      ::overall_system_rtstate::_Controller_default_instance_);
}
inline const ::overall_system_rtstate::Controller& SystemRtState::controller() const {
  // @@protoc_insertion_point(field_get:overall_system_rtstate.SystemRtState.controller)
...
inline void SystemRtState::unsafe_arena_set_allocated_controller(
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:overall_system_rtstate.SystemRtState.controller)
}
inline ::overall_system_rtstate::Controller* SystemRtState::release_controller() {
  
  ::overall_system_rtstate::Controller* temp = _impl_.controller_;
  _impl_.controller_ = nullptr;
#ifdef PROTOBUF_FORCE_COPY_IN_RELEASE
  auto* old =  reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(temp);
  temp = ::PROTOBUF_NAMESPACE_ID::internal::DuplicateIfNonNull(temp);
...
inline ::overall_system_rtstate::Controller* SystemRtState::unsafe_arena_release_controller() {
  // @@protoc_insertion_point(field_release:overall_system_rtstate.SystemRtState.controller)
  
  ::overall_system_rtstate::Controller* temp = _impl_.controller_;
  _impl_.controller_ = nullptr;
  return temp;
}
inline ::overall_system_rtstate::Controller* SystemRtState::_internal_mutable_controller() {
  
  if (_impl_.controller_ == nullptr) {
    auto* p = CreateMaybeMessage<::overall_system_rtstate::Controller>(GetArenaForAllocation());
    _impl_.controller_ = p;
  }
  return _impl_.controller_;
}
inline ::overall_system_rtstate::Controller* SystemRtState::mutable_controller() {
  ::overall_system_rtstate::Controller* _msg = _internal_mutable_controller();
  // @@protoc_insertion_point(field_mutable:overall_system_rtstate.SystemRtState.controller)
  return _msg;
}
inline void SystemRtState::set_allocated_controller(::overall_system_rtstate::Controller* controller) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArenaForAllocation();
  if (message_arena == nullptr) {
    delete _impl_.controller_;
  }
  ...
  _impl_.controller_ = controller;
  // @@protoc_insertion_point(field_set_allocated:overall_system_rtstate.SystemRtState.controller)
}

// string system_info = 5;
inline void SystemRtState::clear_system_info() {
  _impl_.system_info_.ClearToEmpty();
}
inline const std::string& SystemRtState::system_info() const {
  // @@protoc_insertion_point(field_get:overall_system_rtstate.SystemRtState.system_info)
  return _internal_system_info();
}
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void SystemRtState::set_system_info(ArgT0&& arg0, ArgT... args) {
 
 _impl_.system_info_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:overall_system_rtstate.SystemRtState.system_info)
}
inline std::string* SystemRtState::mutable_system_info() {
  std::string* _s = _internal_mutable_system_info();
  // @@protoc_insertion_point(field_mutable:overall_system_rtstate.SystemRtState.system_info)
  return _s;
}
inline const std::string& SystemRtState::_internal_system_info() const {
  return _impl_.system_info_.Get();
}
inline void SystemRtState::_internal_set_system_info(const std::string& value) {
  
  _impl_.system_info_.Set(value, GetArenaForAllocation());
}
inline std::string* SystemRtState::_internal_mutable_system_info() {
  
  return _impl_.system_info_.Mutable(GetArenaForAllocation());
}
inline std::string* SystemRtState::release_system_info() {
  // @@protoc_insertion_point(field_release:overall_system_rtstate.SystemRtState.system_info)
  return _impl_.system_info_.Release();
}
inline void SystemRtState::set_allocated_system_info(std::string* system_info) {
  if (system_info != nullptr) {
    
  } else {
    
  }
  _impl_.system_info_.SetAllocated(system_info, GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (_impl_.system_info_.IsDefault()) {
    _impl_.system_info_.Set("", GetArenaForAllocation());
  }
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:overall_system_rtstate.SystemRtState.system_info)
}
